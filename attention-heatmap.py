...
def visulize_attention_ratio(img_path, attention_mask, ratio=0.5, cmap="jet",size=320):
    """
    img_path: 读取图片的位置
    ...
    plt.imshow(normed_mask, alpha=0.5, interpolation='nearest', cmap=cmap)  ###############可调
    plt.show()
...
attention_maps = cache['Attention_block.forward']
print(len(attention_maps))
#print(attention_maps[8])

#visualize_grid_to_grid(attention_maps[0][0,0,1:,1:], 0, image)
visulize_attention_ratio(r'',attention_maps[6][0,0,1:,1:])
